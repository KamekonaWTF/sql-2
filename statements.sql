...
UPDATE usuarios SET id_rol = 2 WHERE id = 2;
UPDATE usuarios SET id_rol = 3 WHERE id = 3;
UPDATE usuarios SET id_rol = 4 WHERE id = 4;
...
FROM usuarios
JOIN roles ON usuarios.id = roles.id_rol;
...
UPDATE usuarios SET id_categoria = 1 WHERE id_usuario IN (4, 8, 12, 16, 20);


-- PASO 4
SELECT usuarios.id, usuarios.nombre, usuarios.apellido, usuarios.email, usuarios.edad, usuarios.id_rol, categorias.nombre_categoria 
FROM usuarios
JOIN categorias ON usuarios.id = categorias.id_categoria;
